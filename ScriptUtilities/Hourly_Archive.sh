...
# After the script reaches the "Main Script" portion of Hourly_Archive.sh, the
# script is an exact duplicate of the Daily_Archive.sh!

# Hourly_Archive.sh retrieves the day and month values from the date command,
# along with the time stamp used to uniquely identify the archive file. 
